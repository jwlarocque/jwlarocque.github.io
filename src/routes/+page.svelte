...
<!-- <div id="boidsCaption" class="caption">
	<h5>Boids of a Feather</h5>
	<p>Craig Reynolds's classic "boids" simulation, with additional behavior. These boids are easily startled by the mouse cursor but will return to their perches to rest.</p>
</div> -->
...
<div id="content">
	...
	<div id="projects">
		...
		<div id="holotree" class="project">
			...
			<div class="caption">
				<h3><a href="https://photos.app.goo.gl/REeTZcCMmZKRN3hXA">Volumetric Display Christmas Tree</a><span class="deemph date">Winter 2023</span></h3>
		...
		<div id="card2022" class="project">
			...
			<div class="caption">
				<h3><a href="card2022.html">Pen-Plotted Christmas Card</a><span class="deemph date">Winter 2022</span></h3>
